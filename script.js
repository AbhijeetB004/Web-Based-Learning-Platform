...
document.addEventListener("DOMContentLoaded", function () {
  // Get the element with id "Fundamental"
  var funda = document.getElementById("Fundamentals");

  // Check if the element exists
  if (funda) {
    // Add click event listener
    funda.addEventListener("click", function () {
      // Redirect to fundamental.html
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (q1) {
    ...
    q1.addEventListener("click", function () {
      // Redirect to fundamental.html
      window.location.href = "Quiz/quiz_home.html";
    });
  } else {
...
document.addEventListener("DOMContentLoaded", function () {
  // Get the element with id "Fundamental"
  var funda = document.getElementById("BCS_Theory");
  ...
  if (funda) {
    ...
    funda.addEventListener("click", function () {
      // Redirect to fundamental.html
      window.location.href = "BCS_Theory.html";
    });
  } else {
    console.error("Element with id 'BCS_Theory' not found.");
  }
});

document.addEventListener("DOMContentLoaded", function () {
  // Get the element with id "Fundamental"
  var funda = document.getElementById("Meissner_Effect");
  ...
  if (funda) {
    ...
    funda.addEventListener("click", function () {
      // Redirect to fundamental.html
      window.location.href = "Meissner_Effect.html";
    });
  } else {
    console.error("Element with id 'Meissner_Effect' not found.");
  }
});

document.addEventListener("DOMContentLoaded", function () {
  // Get the element with id "Fundamental"
  var funda = document.getElementById("Squid");
  ...
  if (funda) {
    ...
    funda.addEventListener("click", function () {
      // Redirect to fundamental.html
      window.location.href = "Animated_Videos.html";
    });
  } else {
    console.error("Element with id 'Squid' not found.");
  }
});
